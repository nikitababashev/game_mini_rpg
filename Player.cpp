...
void Player::initAnimations() {
    animations.idle_w = { 12, 100, 0 };
    animations.idle_a = { 12, 100, 1 };
    animations.idle_d = { 12, 100, 2 };
    animations.idle_s = { 12, 100, 3 };

    animations.walk_w = { 12, 100, 4 };
    animations.walk_a = { 12, 100, 5 };
    animations.walk_d = { 12, 100, 6 };
    animations.walk_s = { 12, 100, 7 };
...
// НОВЫЙ МЕТОД - смена текстуры при выборе пола
void Player::setGenderTexture(SDL_Texture* newTexture) {
    if (texture) {
